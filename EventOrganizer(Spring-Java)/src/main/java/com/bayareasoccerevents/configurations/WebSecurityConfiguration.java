...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .requestMatchers("/register", "/login", "/logout", "/profile", "/addEvent", "/events", "/dashboard", "/users", "/events/getEventById/{id}", "/reset-password/request", "/reset-password/reset/{token}", "/reset-password/reset").permitAll()
                .and()
